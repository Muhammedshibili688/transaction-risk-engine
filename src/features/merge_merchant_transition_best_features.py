...
NEW_FEATURE_PATH = (
    "datas/experiments/features_merchant_transition_score.parquet"
)
...
def merge_features():
    ...
    new_feature_score_df = pd.read_parquet(
        NEW_FEATURE_PATH  
    )
    ...
    new_feature_score_feature = new_feature_score_df[
        [
            "tx_id",
